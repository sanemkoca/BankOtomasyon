...
namespace BankOtomasyon
{
    abstract class Musteri : Kisi, IMusteriOzellikleri
    {
        ...
        public List<Hesap> hesaplar; //Müsterilerin hesaplarının tutulacağı List<>
        Hesap h;
        string rapor; //İşlemlerin listelenmesi için kullanılacak.
        DateTime tarih;

        public Musteri() //Construction oluşturuldu.
        {
            //Yeni bir müşteri sınıfı oluştuğunda hesaplar sınıfından yeni bir liste oluşturur.
        ...
        public void HesapAc(int ekBakiye)
        {
            ...
            Random r = new Random(); //Hesap numarası için rastgele 3 haneli sayı üretir.
